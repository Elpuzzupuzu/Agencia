...
<head>
    ...
    <title>Registro de Cajeros</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
    <div class="container">
        <h1 class="text-center mt-4 mb-4">Registro de Cajeros</h1>
        ...
        ?>
        <form class="col-4 p-3 mx-auto" action="registrar_cajero.php" method="POST">
