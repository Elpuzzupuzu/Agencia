...
<head>
    ...
    <title>Registro de Contadores</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
    <div class="container">
        <h1 class="text-center mt-4 mb-4">Registro de Contadores</h1>
        ...
        ?>
        <form class="col-4 p-3 mx-auto" action="registrar_contador.php" method="POST">
            <h3 class="text-center text-secondary">Registrar contador</h3>
            <div class="mb-3">
